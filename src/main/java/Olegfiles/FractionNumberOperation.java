...
/**
 * Интерфейс операций с числами Olegfiles.FractionNumber. Для вывода ошибок функции могут бросать ArithmeticException
 * 
 * @author nedis
 * @version 1.0
 */
public interface FractionNumberOperation {
	...
	/**
	 * Сложение двух чисел Olegfiles.FractionNumber
	 * 
	 * @param a первое слагаемое 
	 * @param b второе слагаемое
	 * @return результат в виде числа Olegfiles.FractionNumber
	...
	/**
	 * Вычитание двух чисел Olegfiles.FractionNumber
	 * 
	 * @param a уменьшаемое
	 * @param b вычитаемое
	 * @return результат в виде числа Olegfiles.FractionNumber
	...
	/**
	 * Умнодение двух чисел Olegfiles.FractionNumber
	 * 
	...
	/**
	 * Деление двух чисел Olegfiles.FractionNumber
	 * 
	 * @param a делимое
	 * @param b делитель
	 * @return результат в виде числа Olegfiles.FractionNumber
